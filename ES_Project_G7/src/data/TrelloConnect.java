...
////////////////
	...
	public TrelloConnect(Container pane) throws IOException {
		...
		//teste();
		//getSprints();
		//getCardsFromSprint(getSprint("4th Sprint"));
	}
...
//	public void getCardsFromSprint(TList Sprint) {
...
//	}
	...
	// devolve uma lista de cartões de um sprint
