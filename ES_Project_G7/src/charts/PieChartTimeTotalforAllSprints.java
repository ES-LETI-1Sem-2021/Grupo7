...
public class PieChartTimeTotalforAllSprints extends JFrame {
	private static final long serialVersionUID = 6294689542092367723L;
	private String name1;
	PieDataset dataset;
	private Map<String, Double> mapa = new HashMap<String, Double>();

	public PieChartTimeTotalforAllSprints(String title) {
		super(title);
	...
	private PieDataset createDataset() {
		...
		TrelloConnect trelloconnect = MainWindow.getFrame().getTrelloConnect();
		for (String s : trelloconnect.getAllSprints())
			createDatasetaux(s);
	...
	public static void main(String[] args) throws IOException {
		...
		SwingUtilities.invokeLater(() -> {
			...
			PieChartTimeTotalforAllSprints example = new PieChartTimeTotalforAllSprints("Tempo por Sprint");
