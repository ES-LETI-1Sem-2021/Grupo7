...
public class LayoutBackup extends JPanel {
	 ...
	 */
	public LayoutBackup(LayoutType layoutType, Container pane, TextLabel title, TextLabel[] labels, TextField[] textFields,
			int startingPoint) {
	...
	public LayoutBackup(Layout layout, TextLabel title, TextLabel[] labels, TextField[] textFields, int startingPoint) {
	...
	private void addToLayout(TextLabel title, TextLabel[] labels, TextField[] textFields, int startingPoint) {
